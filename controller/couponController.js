...
class CouponController {
  ...
  createCoupon = async (req, res) => {
    ...
    try {
      ...
      let couponCode = await this.createCouponCode(name);
  ...
  createCouponCode = async function (name) {
    ...
    if (existingCoupon) {
      return await this.createCouponCode(name); // Retry if duplicate
    }
